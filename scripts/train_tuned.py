"""Treina os 5 modelos com hyperparameter tuning e loga no MLflow.

Uso: uv run python scripts/train_tuned.py

Search: perceptron, logreg, dtree -> GridSearchCV (scoring='roc_auc')
...
def main() -> None:
    ...
    print(f"{'='*70}")
    print(f"{'Model':<15} {'roc_auc [PRIMARY]':>18} {'f1_macro':>10}")
    print(f"{'-'*50}")
